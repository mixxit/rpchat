    ...
    try
    {
       ...
       for (World w : player.getServer().getWorlds())
      {
         for (Player p : w.getPlayers())
        {
           if (p.equals(player))
          {
             p.sendMessage("[" + this.parent.getColouredName(player) + "][" + this.parent.getRaceNameShorthand(race) + "] " + ChatColor.WHITE + this.parent.getPlayerDisplayName(player) + " " + this.parent.getPlayerLastName(player) + this.parent.getPlayerTitle(player) + ChatColor.AQUA + ": " + message);
          }
          else {
