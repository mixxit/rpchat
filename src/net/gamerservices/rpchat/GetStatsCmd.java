...
public class GetStatsCmd implements CommandExecutor {
	...
	public boolean onCommand(CommandSender arg0, Command arg1, String arg2,
		...
		player.sendMessage("Base Level: " + this.parent.getPlayerLevel(player) + " ["+this.parent.getPlayerExperience(player)+"/"+this.parent.getExpFromLevel(this.parent.getPlayerLevel(player)+1)+"]");
		...
		player.sendMessage("Hitpoints: " + player.getHealth() + " Hitpoint Shielding: " + this.parent.getPlayerHPBonus(player)+"/" + this.parent.getPlayerHPBonusMax(player));
